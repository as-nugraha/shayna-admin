            ...
            <form action="{{ route('products.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea   name="description"
                                class="form-control @error('description') is-invalid @enderror">{{ old('type') ? old('type') : $item->type }}</textarea>
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-block">Edit Barang</button>
                </div>
            </form>
        </div>
    </div>
